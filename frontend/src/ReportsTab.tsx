...
type ReportsTabProps = Record<string, never>;
    ...
    <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden mb-8">
      <div className="px-6 py-5 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
        <div className="flex items-center gap-3">
          <div
            className={`p-2 rounded-xl ${type === "matched" ? "bg-green-100 text-green-600" : "bg-amber-100 text-amber-600"}`}
          >
            {icon}
          </div>
        ...
        <button
          onClick={() => handleExport(type.toUpperCase() as "MATCHED" | "UNMATCHED")}
